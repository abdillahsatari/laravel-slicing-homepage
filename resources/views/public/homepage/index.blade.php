            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-xl-6 col-md-6">
                    <div class="illastrator_png">
                        <img src="{{ asset('assets/publics/img/banner/edu_ilastration.png') }}" alt="">
                    </div>
                </div>
                <div class="col-xl-6 col-md-6">
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="single_courses">
                                <div class="thumb">
                                    <a href="#">
                                        <img src="{{ asset('assets/publics/img/courses/1.png') }}" alt="">
                                    </a>
                                </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="single_courses">
                                <div class="thumb">
                                    <a href="#">
                                        <img src="{{ asset('assets/publics/img/courses/2.png') }}" alt="">
                                    </a>
                                </div>
                                <div class="courses_info">
                                    <span>Adobe XD</span>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="single_courses">
                                <div class="thumb">
                                    <a href="#">
                                        <img src="{{ asset('assets/publics/img/courses/3.png') }}" alt="">
                                    </a>
                                </div>
                                <div class="courses_info">
                                    <span>Wordpress</span>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="single_courses">
                                <div class="thumb">
                                    <a href="#">
                                        <img src="{{ asset('assets/publics/img/courses/4.png') }}" alt="">
                                    </a>
                                </div>
                                <div class="courses_info">
                                    <span>Photoshop</span>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="single_courses">
                                <div class="thumb">
                                    <img src="{{ asset('assets/publics/img/courses/5.png') }}" alt="">
                                </div>
                                <div class="courses_info">
                                    <span>UI/UX</span>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="single_courses">
                                <div class="thumb">
                                    <a href="#">
                                        <img src="{{ asset('assets/publics/img/courses/6.png') }}" alt="">
                                    </a>
                                </div>
                                <div class="courses_info">
                                    <span>Wordpress</span>
                    ...
                    <div class="col-xl-12">
                        <div class="testmonial_text text-center">
                            <div class="author_img">
                                <img src="{{ asset('assets/publics/img/testmonial/author_img.png') }}" alt="">
                            </div>
                            <p>
        ...
        <div class="row">
            <div class="col-xl-4 col-md-4">
                <div class="single_latest_blog">
                    <div class="thumb">
                        <img src="{{ asset('assets/publics/img/latest_blog/1.png') }}" alt="">
                    </div>
            ...
            <div class="col-xl-4 col-md-4">
                <div class="single_latest_blog">
                    <div class="thumb">
                        <img src="{{ asset('assets/publics/img/latest_blog/2.png') }}" alt="">
                    </div>
                    <div class="content_blog">
                        <div class="date">
                            <p>12 Jun, 2019 in <a href="#">Design tips</a></p>
            ...
            <div class="col-xl-4 col-md-4">
                <div class="single_latest_blog">
                    <div class="thumb">
                        <img src="{{ asset('assets/publics/img/latest_blog/3.png') }}" alt="">
                    </div>
                    <div class="content_blog">
                        <div class="date">
                            <p>12 Jun, 2019 in <a href="#">Design tips</a></p>
